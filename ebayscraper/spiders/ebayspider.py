...
class CardSpider(scrapy.Spider):
    ...
    start_urls = [
        ...
        # "https://www.ebay.com/sch/i.html?_from=R40&_trksid=m570.l1313&_nkw=2018+josh+rosen+psa+10+auto&_sacat=0&LH_TitleDesc=0&LH_Auction=1&_osacat=0&_odkw=2018+josh+rosen+psa+10+auto&LH_Complete=1&LH_Sold=1",
    ...
    def parse(self, response):
        for products in response.xpath('//div/div/ul/li[contains(@class, "s-item" )]'):
            yield {
                ...
                # Handle individual span classes and append them together "@class=s-vj1c12"
